...
class HttpErrors {
  ...
  static classForStatusCode(aStatusCode) {
    ...
    if (!result)
      result = StandardException__default;
    return result;
  }
...
function generateErrorClass(desc, code, message) {
	...
	var errorClass = class extends StandardException__default {
...
HttpErrors.register(StandardException__default);
...
exports.StandardException = StandardException.StandardException;
exports.UserError = StandardException.UserError;
